...
#define FFT_PLAN_C2C(...)       fftwf_plan_dft_3d(__VA_ARGS__)
...
#define FFT_EXEC_C2C(...)       fftwf_execute(__VA_ARGS__)
...
#define FFT_PLAN_C2C(...)       fftw_plan_dft_3d(__VA_ARGS__)
...
#define FFT_EXEC_C2C(...)       fftw_execute(__VA_ARGS__)
